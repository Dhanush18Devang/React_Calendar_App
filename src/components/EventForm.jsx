...
const EventForm = ({
  ...
  useEffect(() => {
    ...
    const conflict = events.some((ev) => {
      ...
      return form.startTime < ev.endTime && form.endTime > ev.startTime;
    });

    setHasConflict(conflict);
  }, [form.date, form.startTime, form.endTime, events]);
  ...
  return (
    <div
      className={`fixed top-1/2 left-1/2 z-50 transform -translate-x-1/2 -translate-y-1/2 
        bg-white border rounded-xl shadow-2xl p-6 w-[400px] max-w-[90vw]
      ...
      <div className="flex gap-2 mb-4">
        <select
          ...
          onChange={(e) => {
            ...
            const newEnd =
              form.endTime && form.endTime >= newStart
                ? form.endTime
                : newStart;
